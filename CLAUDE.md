...
| 0012 | A published graph never carries a contributor's email address; the Author node is labelled by the local part, and the address survives only in `full` |
